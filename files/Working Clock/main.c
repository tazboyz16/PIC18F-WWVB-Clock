...
/* PIN SETUP-PIC18F458			
MCLR					RB7- Not Used left open for Programmer
RA0- LED				RB6- Not Used left open for Programmer
RA1- Screen-Reset		RB5- Screen-E
RA2- Not Used			RB4- Screen-R\W
RA3- RTC-RST			RB3- Screen-RS
RA4- RTC-DATA			RB2- Pin Switch (Update Button)
...
V+						RD7- WWVB input
V-						RD6- Not Used
OSC1					RD5- Sound Output
OSC2					RD4- Button (A_DAY)
...
// Constants
const UINT8 cszDay[7][15] ={" Monday   ", " Tuesday  ", " Wednesday", " Thursday ", " Friday   ", " Saturday", " Sunday   " };
const UINT8 cszMonth[12][10] =  {"January", "February", "March", "April", "May", "June", "July", "August",
                                "September", "October", "November", "December" };

const UINT8 cszTZChange[] = "Select Time Zone:";
const UINT8 cszTimeZone[7][10] ={"Atlantic", "Eastern", "Central", "Mountain", "Pacific", "Alaskan", "Hawaiian" };
const UINT8 cszSet[] = "-> ";
...
void main()
{
    ...
    TRISD = 0b10011111;                         //Sound and buttons input n output     
    g_yUpdate = 0;
...
AlarmDay = tt.day;				//Current Time values used for Alarms
AlarmHR = tt.hr;
AlarmMIN = tt.min;
AlarmSec = tt.sec;
